...
// Route login koperasi
Route::get('/login', function () {
    return view('dashboard.auth.login');
})->name('login');

// Routing logic controller login
...
Route::get('/logout', [KoperasiController::class, 'logout']); // logout
Route::get('/profil', [KoperasiController::class, 'profil']); // ke profil
...
// Routing registrasi anggota melalui primkopnya
